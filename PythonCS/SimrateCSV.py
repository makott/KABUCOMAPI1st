...
import kabu_LongShort as kabuLong
#----------------------------------------------------------
import configparser
...
def SimulateRead():
    ...
    with open(fileName, newline='') as csvfile:
        ...
        for row in reader:
            d_Current = int(row[1])
            # kabuApi_Long1.D_Current = int(row[1])
            # kabuApi_Long1.SimulateTime = row[0]
            ...
            # kabuApi_Long1.D_Current = d_Current
            # kabuApi_Long1.Long_Symbol1(None, None, Symbol, WriteCsvFile)
...
if __name__ == '__main__':
    if(F_Write):
        with open(WritefileName, 'w', encoding='shift_jis') as WriteCsvFile:
            # kabuApi_Long1.WriteCsvFile = WriteCsvFile
